...
class NGCF(nn.Module):
    ...
    def create_bpr_loss(self, users, pos_items, neg_items):
        ...
        mse_loss = F.binary_cross_entropy(nn.sigmoid(scores), self.label.view(1,-1)[0])

        return mf_loss + emb_loss, mf_loss, emb_loss, mse_loss

    def rating(self, u_g_embeddings, pos_i_g_embeddings):
        return F.sigmoid(torch.matmul(u_g_embeddings, pos_i_g_embeddings.t()))
